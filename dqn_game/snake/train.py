...
def trainNetwork(s, readout, h_fc1, sess):
    ...
    while "flappy bird" != "angry bird":
        ...
        x_t1_colored, r_t, terminal, _ = env.step(action)
        ...
        if t % 5000 == 0:
            saver.save(sess, 'saved_networks/snake-dqn', global_step = t)
